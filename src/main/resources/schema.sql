...
INSERT INTO orders (trader_id, stock_id, quantity, price, side, state, created_at, expires_at)
VALUES
    (2, 3, 25, 400, 'BUY', 'PENDING', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP), EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)+7200), -- MSFT
    (2, 4, 10, 180,  'SELL', 'PENDING', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP), EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)+7200), -- GOOGL
    (2, 1, 5, 210, 'SELL', 'PENDING', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP), EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)+7200); -- AAPL
-- finance_user (user_id = 3)
INSERT INTO orders (trader_id, stock_id, quantity, price, side, state, created_at, expires_at)
VALUES
    (3, 6, 20, 180,'BUY', 'PENDING', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP), EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)+3600), -- JPM
    (3, 7, 15, 350, 'SELL', 'PENDING', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP), EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)+3600); -- GS
-- balanced_user (user_id = 4)
INSERT INTO orders (trader_id, stock_id, quantity, price, side, state, created_at, expires_at)
VALUES
    (4, 11, 10, 120, 'BUY', 'PENDING', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP), EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)+3600), -- XOM
    (4, 12, 5, 200, 'SELL', 'PENDING', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP), EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)+3600); -- JNJ
-- mixed_user (user_id = 5)
INSERT INTO orders (trader_id, stock_id, quantity, price, side, state, created_at, expires_at)
VALUES
    (5, 1, 10, 210,  'BUY', 'PENDING', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP), EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)+3600), -- AAPL
    (5, 2, 5, 320, 'SELL', 'PENDING', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP), EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)+3600); -- TSLA